...
import (
	...
	"zlx.io/go-mysql-kafka/river"
)

var configFile = flag.String("config", "./etc/river.toml", "go-mysql-kafka config file")
...
var borkers = flag.String("brokers", "", "brokers")
var data_dir = flag.String("data_dir", "", "path for go-mysql-kafka to save data")
...
func main() {
	...
	if len(*borkers) > 0 {
		cfg.KafkaBrokerServers = *borkers
	}
